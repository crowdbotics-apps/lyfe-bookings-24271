"""lyfe_bookings_24271 URL Configuration
...
admin.site.site_header = "Lyfe Bookings"
admin.site.site_title = "Lyfe Bookings Admin Portal"
admin.site.index_title = "Lyfe Bookings Admin"

# swagger
api_info = openapi.Info(
    title="Lyfe Bookings API",
    default_version="v1",
    description="API documentation for Lyfe Bookings App",
)
